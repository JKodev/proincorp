...
<head>
	<meta charset="utf-8" />
	<title>Proincorp Control Vehicular | Ingreso</title>
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta content="width=device-width, initial-scale=1" name="viewport" />
	<meta content="Control vehicular Proincorp" name="description" />
	<meta content="proincorp" name="author" />
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="{{ route('auth.login.postLogin') }}" method="post">
		...
		<div class="form-group">
			...
			<input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="Usuario" name="name" value="{{ old('name') }}"  /> </div>
		<div class="form-group">
