...
@section('js_level_scripts')
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			var route = '{{  route('app.init') }}/service/reports/portico/general/porcentual/{{ $id }}/{start_date}/{end_date}/';
						...
						"titles": [
							{
								"id": "Title-1",
								"size": 15,
								"text": "Reporte Cámaras vs Tags {{ date('d/m/Y') }}"
							}
						],
			...
			var initChartFunct = function () {
				...
				chart.titles = [];
				var title = "Reporte Cámaras vs Tags " + $("#from").val() + " al " + $("#to").val();
